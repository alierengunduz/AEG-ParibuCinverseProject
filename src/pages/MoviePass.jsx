...
const MoviePass = () => {
  return (
    <div className="w-full min-h-screen bg-[#121212] text-white py-1 flex flex-col items-center justify-start">
      <div className="w-full h-[400px] relative">
        ...
        <div className="text-white flex flex-col gap-y-8 absolute -bottom-80 items-center justify-center px-20">
      ...
      <ul className="mt-96 w-[90%] flex items-center justify-between p-1 my-10">
      ...
      <div className="text-white my-10">
        <h1 className="font-bold text-3xl text-center my-14 tracking-wider">
          CGV MoviePass’i Nasıl Kullanırım?
        </h1>
           

        <div className="flex flex-col items-center justify-start w-full px-20">
  <div className="flex items-center gap-x-10 w-full">
    ...
    <div className="flex flex-col items-start gap-y-5 w-[50%]">
