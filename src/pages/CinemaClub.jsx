  ...
  return (
    <div className="w-full min-h-screen bg-[#121212] text-white py-1 flex flex-col items-center justify-start">
      <div className="w-full h-[400px] relative">
        ...
        />
        <div className="text-white flex flex-col gap-y-8 absolute top-[50%]  left-[20%] items-center justify-center px-20">
          <img
            src="https://www.paribucineverse.com/assets/img/page-cinemaclub/logo.svg"
            alt=""
          />
          <p className="text-lg tracking-wide text-center leading-loose">
            CGV Cinema Club’a üye ol veya giriş yap, anında CGV Para kazan,
            istediğin zaman kullan!
          </p>
          <div className="flex items-center gap-x-10">
            <button className="bg-white text-black px-10 py-3 rounded-3xl">
              Hemen Üye Ol
            </button>
            <button className="text-white bg-[#98A726] px-10 py-3 rounded-3xl">
              Giriş Yap
            </button>
          </div>
        </div>
        <div className="text-3xl ml-10 mt-5 font-bold tracking-wider">
      ...
      <div className="flex items-center justify-between w-full px-10">
        {/* --------section 1-------- */}
        <div className="mt-96 mb-10 w-full flex flex-col items-center gap-y-2">
      ...
      <div className="w-full px-10 my-14">
        <h1 className="text-4xl text-start font-bold tracking-wider">
          Üyelik Fırsatları
        </h1>
        <ul className="my-10">
          <UyelikFırsat/>
